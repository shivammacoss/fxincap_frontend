    ...
    <div className="flex h-screen" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      >
        ...
        <div className="p-3 space-y-1" style={{ borderTop: '1px solid var(--border-color)' }}>
          ...
          <button
            onClick={() => handleNavigation({ id: 'settings', path: '/admin/settings' })}
            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors ${
              sidebarCollapsed ? 'justify-center' : ''
            }`}
            style={{ 
              backgroundColor: activeSection === 'settings' ? 'var(--accent-blue)' : 'transparent',
              color: activeSection === 'settings' ? '#ffffff' : 'var(--text-secondary)' 
            }}
          >
            <Settings size={20} />
