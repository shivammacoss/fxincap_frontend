      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6 text-[12px] leading-[1.6]">
            ...
            <p>
              FX Incap Europe, UAB ("B4X" or "FX Incap") (company code: 306377915) is authorized and regulated by the Bank of Lithuania ("BoL") as a financial brokerage firm and a crypto-asset service provider. B4X is an affiliated entity and wholly owned subsidiary of FX Incap Markets, Inc. ("Parent Company"). B4X's registered address is: Vilniaus g. 33-201, LT-01402 Vilnius, Lithuania.
            </p>
            <p className="font-mono">5070830</p>
            <p>
              FX Incap Markets, Inc. © 2025 FX Incap. All rights reserved.
            </p>
          </div>
        </div>
