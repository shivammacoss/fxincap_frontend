...
const PerpetualFutures = () => {
  return (
    <section className="bg-black text-white py-[80px] md:py-[140px] overflow-hidden">
      <div className="px-[24px] md:px-[60px] max-w-[1440px] mx-auto">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-[64px] lg:gap-[80px]">
          ...
          <div className="w-full lg:w-[480px] flex flex-col pt-0 lg:pt-[40px]">
            ...
            <div className="mb-[12px]">
              <h3 className="text-[#999999] text-[14px] md:text-[18px] font-medium tracking-normal leading-[1.2] uppercase lg:normal-case">
                Perpetual Futures
              </h3>
            </div>
            ...
            <div className="mb-[24px]">
              <h2 
                className="text-[40px] md:text-[48px] leading-[1.1] font-normal text-white"
            ...
            <div className="mb-[32px]">
              <p className="text-[16px] md:text-[18px] leading-[1.6] text-white">
            ...
            <div className="mb-[48px]">
              <a
                href="#"
                className="inline-block bg-[#CFF12F] text-black text-[16px] font-semibold py-[12px] px-[24px] rounded-[24px] hover:opacity-90 transition-opacity"
              >
                Learn more
              </a>
            </div>
